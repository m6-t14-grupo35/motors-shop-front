...
export const ButtonFilter = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center my-2'>
      ...
      <div className={`w-full md:flex justify-center md:place-content-evenly bg-red-400 ${isOpenFilter === true ? 'flex' : 'hidden'}`}>
        <div className='flex flex-col max-h-[90rem] overflow-x-auto scroll-smooth items-start w-[96.3%] bg-lime-900 max-w-[28rem] px-3 py-3'>
