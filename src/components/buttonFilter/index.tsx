...
export const ButtonFilter = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center my-2'>
      <button className='button-big-text text-grey-whiteFixed bg-brand-2 rounded w-[279px] h-12 cursor-pointer md:hidden' onClick={handleToggleFilter}>Filtros</button>
